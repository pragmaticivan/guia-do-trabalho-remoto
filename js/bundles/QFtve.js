...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QFtve", function() { return QFtve; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(1);
...
/**
 * @fileoverview Templates in namespace QFtve.
 * @public
 */

goog.module('QFtve.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param157 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_close('h2');
      ie_open('p');
        itext('Para empresas no Brasil, voc\u00EA pode continuar com o modelo CLT ou PJ (Pessoa Jur\u00EDdica) normalmente, mesmo n\u00E3o residindo no estado da empresa, embora seja necess\u00E1rio ir algumas vezes visitar a empresa para resolver burocracias.');
      ie_close('p');
      ie_open('h2');
        itext('No Exterior');
      ie_close('h2');
      ie_open('p');
        itext('Para empresas no exterior \u00E9 recomendado que voc\u00EA tenha um contrato de presta\u00E7\u00E3o de servi\u00E7os, j\u00E1 que voc\u00EA n\u00E3o \u00E9 diretamente contratado no modelo formal. Este contrato ir\u00E1 comprovar a origem e legalidade do dinheiro que voc\u00EA ir\u00E1 receber.');
      ie_close('p');
      ie_open('p');
        itext('Este contrato pode ser tanto como pessoa f\u00EDsica ou jur\u00EDdica, geralmente esse detalhe \u00E9 irrelevante para a empresa que contrata. No entanto, para fins cont\u00E1beis, faz muita diferen\u00E7a.');
      ie_close('p');
      ie_open('h3');
        itext('Como Pessoa F\u00EDsica');
      ie_close('h3');
      ie_open('p');
      ...
      ie_close('p');
      ie_open('h3');
        itext('Como Pessoa Jur\u00EDdica');
      ie_close('h3');
      ie_open('p');
        itext('\u00C9 importante consultar um contador capacitado para discutir estes assuntos. De forma resumida, se sua empresa \u00E9 um MEI ou est\u00E1 no Simples, n\u00E3o h\u00E1 nada de novo. No entanto, se voc\u00EA optar pelo Lucro Presumido (ou mudar para ele), \u00E9 poss\u00EDvel obter isen\u00E7\u00E3o de ');
        ie_open('a', null, null,
            'href', 'http://www.planalto.gov.br/ccivil_03/constituicao/Constituicao.htm#art149\u00A72i');
          itext('PIS, Cofins');
        ie_close('a');
        itext(', ');
        ie_open('a', null, null,
            'href', 'http://www.planalto.gov.br/ccivil_03/leis/LCP/Lcp116.htm#art2');
          itext('ISS');
        ie_close('a');
        itext(' e ');
        ie_open('a', null, null,
            'href', 'http://www.planalto.gov.br/ccivil_03/_ato2007-2010/2007/decreto/d6306.htm#art15bi');
          itext('IOF (sobre c\u00E2mbio)');
        ie_close('a');
        itext(' nas opera\u00E7\u00F5es e notas da empresa, por causa de incentivos do governo a exportadores de servi\u00E7os (que \u00E9 o nosso caso).');
      ie_close('p');
      ie_open('p');
        itext('Verifique com seu contador se os custos de abrir e manter a empresa ser\u00E3o compensados pela redu\u00E7\u00E3o de impostos, comparando com os custos do IRPF. Em geral, se voc\u00EA vai receber mensalmente, vale.');
      ie_close('p');
    ie_close('article');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'QFtve.render';
}
...
class QFtve extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(QFtve, templates);
...
var QFtve = function (_Component) {
  _inherits(QFtve, _Component);

  function QFtve() {
    _classCallCheck(this, QFtve);

    return _possibleConstructorReturn(this, (QFtve.__proto__ || Object.getPrototypeOf(QFtve)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QFtve, _indexSoy2.default);

exports.default = QFtve;
